...
void main() {
  // Create LANY songs
  Song song1 = Song('Stargazing', 'Myles Smith', 240);
  Song song2 = Song('Too Sweet', 'Hozier', 234);
  Song song3 = Song('24/7, 365 ', 'Elijah Woods', 221);
  Song song4 = Song('7/11', 'TOONEEJAY', 237);
  Song song5 = Song('Patutunguhan', 'Cup of Joe', 194);
  Song song6 = Song('Dilaw', 'Maki', 223);
